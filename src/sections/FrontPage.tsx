...
export default function FrontPage() {
  return (
    <section className="relative min-h-screen paper-texture">
      ...
      <article className="mx-auto max-w-[1200px] px-6 pt-10 pb-16 grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        >
          ...
          <figure className="relative">
            <div className="relative w-full aspect-[4/5] md:aspect-[5/4] bg-paper-deep border border-ink overflow-hidden">
              <Image
